...
public class GameServletTest {
	...
	// Expose newGame() and getGame() for other tests
	protected Response getGame( long id ) {
		TestGameServlet gameServlet = new TestGameServlet();
		Response response = gameServlet.getGame( id );
		return response;
	}
	
	protected Response newGame( Game game ) {
		TestGameServlet gameServlet = new TestGameServlet();
	...
	@Test
	// Tests Game.Servlet.newGame() and GameServlet.getGame()
	public void testGameServlet() {
		...
		// Retrieve the game details and test the match
		TestGameServlet gameServlet = new TestGameServlet();
		Response response;
